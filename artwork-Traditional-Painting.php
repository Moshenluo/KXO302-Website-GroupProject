...
include "header.php";
// 执行查询
// 获取到的类型值（可以是 Traditional Painting, Digital Design, Sketch）
$type = $_GET['type'] ?? 'Traditional Painting';

// 查询特定类型的艺术品
$sql = "SELECT * FROM artwork WHERE type = ?";
    ...
    <div class="gallery">
        <div class="collapse navbar-collapse" id="bs-example-navbar-collapse-1" style="margin-left:25%">
            <ul class="nav navbar-nav">
                ...
                <li><a href="artwork-Traditional-Painting.php" style="color:black;font-size:25px;margin-left:15px">Traditional Painting</a></li>
                <li><a href="artwork-Digital-Design.php" style="color:black;font-size:25px;margin-left:15px">Digital Design</a></li>
                <li><a href="artwork-Sketch.php" style="color:black;font-size:25px;margin-left:15px">Sketch</a></li>
